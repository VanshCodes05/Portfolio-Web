        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                JavaScript and TypeScript — from UI and REST APIs to deployment,
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing ML models, data preprocessing pipelines, and intelligent
                features. Experienced with supervised learning, model evaluation,
                and bridging AI capabilities with real-world applications.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
